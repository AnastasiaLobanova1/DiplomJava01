...
Параллельно вы можете делать дополнительное задание в более свободной форме (см. ниже).
...
Формат оформления баг-репорта вам [был дан](https://github.com/AMuzhev/javaqa-homeworks/blob/main/JAVA_INTRO.md) в первом домашнем задании.
...
- CI-сборка зелёная.
- Отправлена ссылка на публичный репозиторий преподавателю (сдача задания файлом с ссылкой не принимается).
